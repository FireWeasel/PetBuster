 		...
 		<div id="container">
 			<div id="container-wrapper">
				...
				<form action="#" id = "form1">
					...
					<input type="text" name="post-title" id ="postname" class="postname"><span id = "Errorpostname" class="errorpostname"></span><br>
					<label>Description:</label>
					<textarea style="resize:none" name="description" id = "description" class="description"></textarea><span id="errordescription" class="errordescription"></span><br>
